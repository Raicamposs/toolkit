...
export abstract class WatchedList<T> {
  ...
  constructor(initialItems?: T[]) {
    this.currentItems = [...coalesce(initialItems, [])];
    this.initial = [...coalesce(initialItems, [])];
    this.new = [];
    this.removed = [];
  }
  ...
  public getKeptItems(): T[] {
    return this.currentItems.filter((item) => this.wasAddedInitially(item) === true);
  }
  ...
  public addAll(items: Array<T>): void {
