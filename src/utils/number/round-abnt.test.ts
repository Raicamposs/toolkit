...
describe('RoundNumber', () => {
  ...
  it('should return value when fractionDigits is undefined', () => {
    expect(roundABNT(0.342)).toBe(0.342);
    expect(roundABNT(0.346)).toBe(0.346);
    expect(roundABNT(0.3452)).toBe(0.3452);
    expect(roundABNT(0.345)).toBe(0.345);
    expect(roundABNT(0.332)).toBe(0.332);
    expect(roundABNT(0.336)).toBe(0.336);
    expect(roundABNT(0.3352)).toBe(0.3352);
    expect(roundABNT(0.335)).toBe(0.335);
    expect(roundABNT(0.305)).toBe(0.305);
    expect(roundABNT(0.315)).toBe(0.315);

    expect(roundABNT(1.333)).toBe(1.333);
    expect(roundABNT(1.666)).toBe(1.666);
    expect(roundABNT(4.8501)).toBe(4.8501);
    expect(roundABNT(4.55)).toBe(4.55);
    expect(roundABNT(4.85)).toBe(4.85);
  });

  it('should throw error when fractionDigits is less than 0', () => {
    expect(() => roundABNT(0.342, -1)).toThrowError(
