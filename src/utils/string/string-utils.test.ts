...
describe('StringUtils', () => {
  ...
  it('should slugify a string', () => {
    ...
    expect(StringUtils.slugify('Hello World!', '-')).toBe('hello-world');
    expect(StringUtils.slugify(null as any)).toBe(null);
    expect(StringUtils.slugify(undefined as any)).toBe(undefined);
    expect(StringUtils.slugify('null')).toBe('null');
    expect(StringUtils.slugify('undefined')).toBe('undefined');
    expect(StringUtils.slugify('Hello World_', '-')).toBe('hello-world');
  });
  ...
  it('should remove accents', () => {
    ...
    expect(StringUtils.removeAccents(null as any)).toEqual(null);
    expect(StringUtils.removeAccents(undefined as any)).toEqual(undefined);
